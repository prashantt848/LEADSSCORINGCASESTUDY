...
- Precision- Recall
- Files:
- Assignment Subjective Questions.pdf-This file includes all answers of subjective questions.
- CASE STUDY.pdf-Power Point Presentation
- Lead Score Case Study.ipynb-The python file 
